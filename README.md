# LumynaX Multimodal GLM 4.6V Flash

> 🇳🇿 **Made in Aotearoa New Zealand** by **AbteeX AI Labs** — part of the **LumynaX** sovereign-AI release family.

[🤗 Weights & model card on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-multimodal-glm46v-flash) · [abteex.com](https://abteex.com) · [lumynax.com](https://lumynax.com) · [Monorepo](https://github.com/Aimaghsoodi/lumynax-release)

---

This GitHub repo mirrors the **runtime scaffolding** (quickstart, requirements, Modelfile, Space, docs). The model **weights** are published on Hugging Face at `AbteeXAILab/lumynax-multimodal-glm46v-flash` — they exceed GitHub's per-file limit.

```bash
hf download AbteeXAILab/lumynax-multimodal-glm46v-flash --local-dir lumynax-multimodal-glm46v-flash
cd lumynax-multimodal-glm46v-flash && pip install -r requirements.txt && python quickstart.py --interactive
# Or:  pip install lumynax && lumynax run lumynax-multimodal-glm46v-flash -i
```
...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Multimodal GLM 4.6V Flash release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Multimodal GLM 4.6V Flash</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: lumynax" src="https://img.shields.io/badge/Family-lumynax-9a5416?style=for-the-badge" />  <img alt="Runtime: llama%20cpp%20multimodal" src="https://img.shields.io/badge/Runtime-llama%20cpp%20multimodal-726b62?style=for-the-badge" />  <img alt="Modes: text+image" src="https://img.shields.io/badge/Modes-text+image-4d6b44?style=for-the-badge" />  <img alt="Params: see%20manifest" src="https://img.shields.io/badge/Params-see%20manifest-0a0a0b?style=for-the-badge" />  <img alt="Quant: UD-IQ2_M" src="https://img.shields.io/badge/Quant-UD--IQ2__M-111827?style=for-the-badge" />  <img alt="Context: 4096%20tok" src="https://img.shields.io/badge/Context-4096%20tok-111827?style=for-the-badge" />  <img alt="License: apache-2.0" src="https://img.shields.io/badge/License-apache--2.0-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%202" src="https://img.shields.io/badge/Sovereignty-tier%202-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>
...
> `AbteeXAILab/lumynax-multimodal-glm46v-flash` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-multimodal-glm46v-flash --local-dir lumynax-multimodal-glm46v-flash
cd lumynax-multimodal-glm46v-flash
...
processor = AutoProcessor.from_pretrained("AbteeXAILab/lumynax-multimodal-glm46v-flash", trust_remote_code=True)
model = AutoModelForCausalLM.from_pretrained("AbteeXAILab/lumynax-multimodal-glm46v-flash", device_map="auto", torch_dtype=torch.float16, trust_remote_code=True)
...
```bash
sha256sum "lumynax-multimodal-glm46v-flash-ud-iq2_m.gguf"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "lumynax-multimodal-glm46v-flash-ud-iq2_m.gguf"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Multimodal GLM 4.6V Flash` |
| Repository | `AbteeXAILab/lumynax-multimodal-glm46v-flash` |
| Family | `lumynax` |
...
| Field | Value |
| --- | --- |
| Primary | `lumynax-multimodal-glm46v-flash-ud-iq2_m.gguf` |
| Weight size | `5.38 GB` |
| Parameters | `see manifest` |
| Quality rank | `3` (1 best) |
| Cost rank | `6` (1 cheapest) |
...
| Field | Value |
| --- | --- |
| Upstream / base | `zai-org/GLM-4.6V-Flash` |
...
| Sovereignty tier | `2` of 5 |
| Runtime residency | `llama_cpp_multimodal` can be deployed inside an operator-approved environment. |
| Primary artifact | `lumynax-multimodal-glm46v-flash-ud-iq2_m.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
```text
lumynax-multimodal-glm46v-flash/
├── README.md                       # this card
...
└── lumynax-multimodal-glm46v-flash-ud-iq2_m.gguf# primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Multimodal GLM 4.6V Flash package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
